...
function deathstats.fracture_corpse_limbs(corpse, custom_angles)
    ...
    if custom_angles and type(custom_angles) == "table" then
        ...
        -- Left Arm: 70% chance splayed outwards (-80 to -35 deg), 30% folded inward across torso (+20 to +55 deg)
        local left_arm_deg = (math.random() < 0.7) and random_float(-80, -35) or random_float(20, 55)
        -- Right Arm: 70% chance splayed outwards (+35 to +80 deg), 30% folded inward across torso (-55 to -20 deg)
        local right_arm_deg = (math.random() < 0.7) and random_float(35, 80) or random_float(-55, -20)
        -- Left Leg: 70% chance splayed outwards (+15 to +50 deg), 30% twisted inward (-30 to -10 deg)
        local left_leg_deg = (math.random() < 0.7) and random_float(15, 50) or random_float(-30, -10)
        -- Right Leg: 70% chance splayed outwards (-50 to -15 deg), 30% twisted inward (+10 to +30 deg)
        local right_leg_deg = (math.random() < 0.7) and random_float(-50, -15) or random_float(10, 30)
        -- Head: limp neck turned sideways on the floor (-25 to +25 deg)
        local head_deg = random_float(-25, 25)
